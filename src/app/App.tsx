...
const PROJECTS = [
  ...
  },
  {
    ...
    col: "#45aaf2",
    desc: "Short links with click tracking, geo analytics (country/city), expiry dates, React dashboard with line + bar charts showing click data over time.",
    moves: [
      { name: "Geo Tracking",     power: 76 },
      { name: "Analytics Chart",  power: 70 },
      { name: "Short URL",        power: 74 },
      { name: "MongoDB",          power: 80 },
    ],
    tags: ["JavaScript", "MongoDB", "Express", "REST API", "React"],
